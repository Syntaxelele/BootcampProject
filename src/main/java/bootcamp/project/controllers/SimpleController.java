...
public class SimpleController {
	...
	public String testDBModel() {
		...
		Grade g2 = new Grade(9, c1);
		Grade g3 = new Grade(4, c2);
		Grade g4 = new Grade(5, c2);
		Grade g5 = new Grade(5, c1);
		gradeRepo.save(g1);
		gradeRepo.save(g2);
		gradeRepo.save(g3);
		gradeRepo.save(g4);
		...
		Student s1 = new Student("Janis", "Berzins", "niks", "passwords", 2, "inbox@inbox.lv", gradesForJanis);
		Student s2 = new Student("Líga", "Liepa", "nickname", "passworasdds", 2, "inboax@inbox.lv", gradesForLiga);
		Student s3 = new Student("Roberts", "Ziema", "dsafas", "passwdsadasords", 2, "inbaaox@inbox.lv", gradesForRoberts);
		studentRepo.save(s1);
